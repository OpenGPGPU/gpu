...
class KernelVertStage(
  ...
  private val snapBlendCfgEnable = Reg(Bool())
  private val snapBlendSrcFactor = Reg(UInt(4.W))
  private val snapBlendDstFactor = Reg(UInt(4.W))
  private val snapBlendEquation = Reg(UInt(3.W))
  private val snapStencilTestEnable = Reg(Bool())
  private val snapStencilFunc = Reg(UInt(3.W))
  private val snapStencilRef = Reg(UInt(8.W))
  private val snapStencilReadMask = Reg(UInt(8.W))
  private val snapStencilWriteMask = Reg(UInt(8.W))
  private val snapStencilFailOp = Reg(UInt(3.W))
  private val snapStencilZFailOp = Reg(UInt(3.W))
  private val snapStencilZPassOp = Reg(UInt(3.W))
  ...
  io.vertOut.bits.blendCfgEnable := snapBlendCfgEnable
  io.vertOut.bits.blendSrcFactor := snapBlendSrcFactor
  io.vertOut.bits.blendDstFactor := snapBlendDstFactor
  io.vertOut.bits.blendEquation := snapBlendEquation
  io.vertOut.bits.stencilTestEnable := snapStencilTestEnable
  io.vertOut.bits.stencilFunc := snapStencilFunc
  io.vertOut.bits.stencilRef := snapStencilRef
  io.vertOut.bits.stencilReadMask := snapStencilReadMask
  io.vertOut.bits.stencilWriteMask := snapStencilWriteMask
  io.vertOut.bits.stencilFailOp := snapStencilFailOp
  io.vertOut.bits.stencilZFailOp := snapStencilZFailOp
  io.vertOut.bits.stencilZPassOp := snapStencilZPassOp
  ...
  switch(state) {
    is(sIdle) {
      when(io.start && io.vertCount >= 3.U) {
        ...
        snapBlendCfgEnable := io.blendCfgEnable
        snapBlendSrcFactor := io.blendSrcFactor
        snapBlendDstFactor := io.blendDstFactor
        snapBlendEquation := io.blendEquation
        snapStencilTestEnable := io.stencilTestEnable
        snapStencilFunc := io.stencilFunc
        snapStencilRef := io.stencilRef
        snapStencilReadMask := io.stencilReadMask
        snapStencilWriteMask := io.stencilWriteMask
        snapStencilFailOp := io.stencilFailOp
        snapStencilZFailOp := io.stencilZFailOp
        snapStencilZPassOp := io.stencilZPassOp
